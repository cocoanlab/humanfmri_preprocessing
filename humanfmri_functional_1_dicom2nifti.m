function PREPROC = humanfmri_functional_1_dicom2nifti(subject_dir, session_n, disdaq_n)
...
% :Usage:
% ::
%    PREPROC = apfmri_functional_1_dicom2nifti(subject_dir, session_num, disdaq);
%
%    e.g. 
%       session_num = 1;
%       disdaq = 5;
