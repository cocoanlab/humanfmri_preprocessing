function PREPROC = humanfmri_functional_2_implicitmask_savemean(subject_dir, session_num)
...
% :Usage:
% ::
%        humanfmri_functional_2_implicitmask_savemean(subject_dir, session_num)
%
% :Input:
% ::
